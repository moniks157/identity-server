            ...
            services.AddOperationalDbContext(
                options =>
                {
                    options.ConfigureDbContext = b =>
                        b.UseSqlServer(connectionString, b => b.MigrationsAssembly("Shelfie.Identity.DataAccess"));
                });
            ...
            if (alice == null)
            {
                ...
                result = userMgr.AddClaimsAsync(
                    ...
                    new[]
                    {
                        ...
                        new System.Security.Claims.Claim(JwtClaimTypes.WebSite, "https://alice.com")
                    }).Result;
                if (!result.Succeeded)
                {
                    throw new Exception(result.Errors.First().Description);
